...
const Details = (props) => {
    ...
    useEffect(() => {
        ...
        xhrMovie.onreadystatechange = () => {
            if (xhrMovie.readyState === 4) {
                setMovie(JSON.parse(xhrMovie.responseText));
            }
        };
    ...
    return (
        <div className="details">
            <Header id={props.match.params.id} baseUrl={props.baseUrl} showButton="true" />
            <div className="back">
                <Typography>
